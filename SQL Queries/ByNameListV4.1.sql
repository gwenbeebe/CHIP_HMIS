...
1.5.22	-	Fixed bug causing open street outreach enrollments to pull people on
...
(SELECT E.EnrollID, E.ClientID, E.CaseID, E.EnrollDate, E.EnrollAssessmentID, E.ExitDate, E.ExitDestination
...
WHERE E.ExitDestination IN (1, 2, 16, 18,															-- include all exits to ES, SH, TH, or unsheltered homelessness
	...
	OR (ExitDate IS NULL
		AND (P.ProgramType IN (1, 2, 8)																-- include all open enrollments in ES, SH, and TH programs
			OR
